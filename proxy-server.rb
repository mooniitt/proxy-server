class ProxyServer < Formula
  ...
  homepage "https://github.com/mooniitt/proxy-server"
  url "https://github.com/mooniitt/proxy-server/archive/v0.1.0.tar.gz" # Replace with a specific release archive URL
